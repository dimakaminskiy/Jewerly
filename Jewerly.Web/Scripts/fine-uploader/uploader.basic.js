qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            typeError: "{file} Выбран неверный тип файла. Поддерживаемые типы: {extensions}.",
            ...
            emptyError: "{file} пуст, пожалуйста, выберите ещё раз.",
            noFilesError: "Нет файла для загрузки.",
            onLeave: "Идёт загрузка. Если Вы закроете окно, загрузка будет прервана"
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
